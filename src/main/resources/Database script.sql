...
ALTER TABLE "users" ADD FOREIGN KEY ("design_theme_id") REFERENCES "design_themes" ("dt_id");

ALTER TABLE "diagrams" ADD FOREIGN KEY ("group_id") REFERENCES "groups" ("g_id");
...
ALTER TABLE "groups" ADD FOREIGN KEY ("group_access_level_id") REFERENCES "group_access_levels" ("gal_id");

ALTER TABLE "group_users" ADD FOREIGN KEY ("group_id") REFERENCES "groups" ("g_id");
...
INSERT INTO "design_themes" ("dt_name") VALUES
                                            ('light'),
                                            ('dark');
...
INSERT INTO "group_access_levels" ("gal_name") VALUES
                                                   ('entry access'),
                                                   ('access is closed');
INSERT INTO "group_users_roles" ("gur_name") VALUES
                                                 ('participant'),
                                                 ('admin');